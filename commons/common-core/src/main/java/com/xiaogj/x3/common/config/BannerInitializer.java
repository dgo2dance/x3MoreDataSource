package com.xiaogj.x3.common.config;

import com.xiaogj.x3.common.constant.CommonConstant;
import com.xiaogj.x3.common.utils.CustomBanner;
...
public class BannerInitializer implements ApplicationContextInitializer<ConfigurableApplicationContext> {
    ...
    public void initialize(ConfigurableApplicationContext applicationContext) {
        if (!(applicationContext instanceof AnnotationConfigApplicationContext)) {
            LogoBanner logoBanner = new LogoBanner(BannerInitializer.class, "/zltmp/logo.txt", "Welcome to X3", 5, 6, new Color[5], true);
